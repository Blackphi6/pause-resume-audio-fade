...
**今回（1.5.1・X/Instagram追加）で変わったところ:**
...
|--------------------|--------------------|----------|
| パッケージ（左メニュー） | （ファイル） | リポジトリ直下の `youtube-pause-resume-fade-1.5.1.zip` |
...
- [ ] `youtube-pause-resume-fade-1.5.1.zip` のルート直下に `manifest.json` がある
